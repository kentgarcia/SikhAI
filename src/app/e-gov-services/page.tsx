...
const EGovernmentServicesPage: React.FC = () => {
  const services = [
    ...
    },
    {
      ...
      contact: '(044) 987-6543',      process: 'Step 1: click the Learn More button to Visit the PESO online portal. Step 2: Register or log in. Step 3: Browse job listings and apply online.',
    ...
    },
    {
      ...
      contact: 'roar-support@example.com',      process: 'click the Learn More button to Visit the ROAR portal website. Step 2: Log in or create an account. Step 3: Navigate through available services.',
    ...
    },
    {
      ...
      location: 'Business Permits and Licensing Office, City Hall',
      contact: '(044) 234-5678',      process: 'Step 1: Click the Learn More button to redirect toDownload application forms from the BPLO website or get them at the office. Step 2: Complete the forms and gather required documents. Step 3: Submit your application to BPLO. Step 4: Pay the necessary fees. Step 5: Await permit processing.',
    ...
    },
    {
      ...
      contact: '(044) 345-6789',      process: 'Step 1: Click the Learn More button to redirect to Obtain the application form from CENRO. Step 2: Fill out the form and provide necessary details about the posting. Step 3: Submit the application to CENRO for evaluation. Step 4: Pay the corresponding fee upon approval.',
    ...
    },
    {
      ...
      location: 'City Environment and Natural Resources Office (CENRO), City Hall',
      contact: '(044) 456-7890',      process: 'Step 1: Click the Learn More button to redirect to the clearance form from CENRO. Step 2: Complete the form and attach required supporting documents. Step 3: Submit your application for review. Step 4: Pay the clearance fee upon issuance.',
    ...
    },
    {
      ...
      contact: 'comelec-support@example.com',      process: 'Step 1: click the Learn More button to Visit the Visit the COMELEC precinct finder website or visit the local COMELEC office. Step 2: Enter your required information (e.g., name, birthdate). Step 3: Your precinct details will be displayed.',
